...
SOURCE_PROFILES: tuple[SourceProfile, ...] = (
    ...
    _profile("court-opinion-v1", "court_opinions", "court_opinion", ("opinion_id",), ("case_name", "docket_number", "citation", "date_decided", "opinion_type", "holding", "pdf_text"), ALL_CONCEPT_SCHEMES, "hierarchical-document"),
    ...
    _profile("court-opinion-cluster-v1", "court_opinion_clusters", "court_opinion_cluster", ("cluster_id",), ("case_name", "case_name_full", "nature_of_suit", "posture", "syllabus", "headnotes", "summary", "disposition", "procedural_history", "headmatter"), ALL_CONCEPT_SCHEMES, "hierarchical-document"),
    _profile("court-opinion-body-v1", "court_opinion_bodies", "court_opinion_body", ("opinion_id",), ("opinion_type", "author_str", "plain_text", "html_with_citations"), ALL_CONCEPT_SCHEMES, "hierarchical-document"),
