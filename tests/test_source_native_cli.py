    ...
    return {
        "data": {
            ...
            "attributes": {
                ...
                "fileFormats": [
                    {
                        "fileUrl": ("https://downloads.regulations.gov/EPA-2026-0001-0001/content.pdf"),
                        "format": "pdf",
                        "size": 10,
                    }
                ],
...
def test_cli_publishes_and_independently_verifies_with_machine_output(
    ...
    assert published["logicalId"].startswith("urn:spicy:artifact:spicyregs-source-native-release:")
