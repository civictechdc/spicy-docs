...
| [FEC](sources/fec.md) | Explicit API filters, bulk prefixes, sitemaps or selected originals | Metadata and retained responses; linked bodies are acquired separately. Committee, processed-filing, candidate, legal-search and audit profiles can seal one pinned observed query. Raw-reader output and other families do not automatically become releases. |
