...
both are legislative hearings; the other 18 state no `COVER` bill, and whether
they are oversight hearings was not classified (see what could not be
established). 0 of 3 sampled **Senate** hearings carry one — those three
...
4 of those 9 carry `BR` documents. Of 46 `BR` documents, **36 resolve to a bill
key** and 10 do not — the `BILLS-118Xih.pdf` discussion drafts.
...
| `daily_digest_entry` | Pilot; needs the multi-Congress parse measurement | 12 of 12 on one entry, 4 of 16 entries carry a bill (the untruncated re-parse; the first 260-character parse said 7) |
...
- **Which of the 18 non-`COVER` hearings are oversight hearings.** The sample
  was 20 House hearings, not 20 legislative hearings; no probe classified
  hearing type, so 2 of 20 is a floor over all hearings, not a rate over
  legislative ones.
