...
| committees | Committee prints | `committee-print` | `candidate` | api.data.gov key | 94th Congress+; updated ≥ 2026-09-18 (sort ignored) | 1,884 | low volume; take with reports |
| committees | Committee rosters | `committee` | `candidate` | api.data.gov key | 1st Congress+; latest 2026-09-08 | 818 | API-first over the Clerk and Senate XML rosters |
...
| treaties | Treaties | `treaty` | `candidate` | api.data.gov key | 81st Congress+; updated ≥ 2026-09-15 (sort ignored) | 786 | not previously mapped |
