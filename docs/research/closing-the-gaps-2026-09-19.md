...
| A8, A9 | In progress: builder branch `worktree-agent-a95d88c5a12a6e7de`, resumed after an API outage killed it mid-measurement. (That is the spicy-docs contract work; the spicy-regs rollups for A8 and A9 have not begun and wait on the 0.21.2 wheel like A5, A7 and A10.) |
