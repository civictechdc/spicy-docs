...
| A7 | code merged in spicy-regs `a934232` (pushed 2026-09-23): label-aware docket reads through spicy-docs' reader (the literal fallback deleted: it changed no join), unpadded FR keys that refuse different-width padding, folds named in status; the rulemaking snapshot is being rebuilt on 0.31.0, validated and published | [survey](parsing-survey-2026-09-23.md); receipt `rulemaking-joins-2026-09-23/` |
